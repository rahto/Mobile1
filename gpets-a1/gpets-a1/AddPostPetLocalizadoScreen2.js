...
export default function AddPostPetLocalizadoScreen2({ navigation }) {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('AddPostPetLocalizado3')}
        >
...
const styles = StyleSheet.create({
  ...
  dashedOuterBox: {
    width: '100%',
    height: 220,
    backgroundColor: '#C5C5FF', // Tom azul claro de fundo
    borderRadius: 15,
    borderWidth: 2,
    borderColor: '#7A7AFF',
    borderStyle: 'dashed',
  ...
  dashedInnerBox: {
    ...
    borderRadius: 10,
    borderWidth: 2,
    borderColor: '#FF00FF', // Borda magenta tracejada
    borderStyle: 'dashed',
    justifyContent: 'center',
    alignItems: 'center',
  },
  ...
  voltarBtn: {
    backgroundColor: '#FF8A5B', // Laranja do botão Voltar
    paddingVertical: 14,
  ...
  proximoBtn: {
    backgroundColor: '#74C37E', // Verde do botão Próximo
    paddingVertical: 14,
    paddingHorizontal: 45,
    borderRadius: 30,
    elevation: 3,
